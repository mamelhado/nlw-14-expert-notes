...
export function NewNoteCard(props: NewNoteCardProps){
    ...
    return(
      <Dialog.Root>
        <Dialog.Trigger className="rounded-md flex flex-col bg-slate-700 text-left p-5 gap-3 outline-none hover:ring-2">
                ...
                shouldShowOnBoarding ? (
                  ...
                  >
                    Comece <button 
                      ...
                      className="font-medium text-lime-400 hover:underline"> gravando uma nota </button> em áudio ou se preferir <button type="button" onClick={handleStartEditor} className="font-medium text-lime-400 hover:underline">utiliza apenas texto.</button>
                  </p>
                ) : (
                  <textarea 
                    autoFocus
